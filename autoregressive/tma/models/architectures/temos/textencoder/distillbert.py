...
class DistilbertEncoderBase(pl.LightningModule):
    ...
    def __init__(self, modelpath: str, finetune: bool = False):
        ...
        self.text_tokenizer = T5Tokenizer.from_pretrained(self.text_model_name,local_files_only=True)
        self.text_model = T5EncoderModel.from_pretrained(self.text_model_name,local_files_only=True)
