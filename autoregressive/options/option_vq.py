...
def get_args_parser():
    ...
    ## dataloader  
    parser.add_argument('--dataname', type=str, default='handx', help='dataset directory')
    parser.add_argument('--batch-size', default=64, type=int, help='batch size')
    parser.add_argument('--window-size', type=int, default=48, help='training motion length')
    ...
    ## vqvae arch
    parser.add_argument("--input-dim", type=int, default=288, help="embedding dimension")
    ...
    parser.add_argument('--vq-norm', type=str, default='LN', help='dataset directory')
    ...
    ## quantizer
    parser.add_argument("--quantizer", type=str, default='FSQ', choices = ['ema', 'orig', 'ema_reset', 'reset', 'LFQ', "FSQ", "BSQ"], help="eps for optimal transport")
    ...
    parser.add_argument('--eval-iter', default=8000, type=int, help='evaluation frequency')
    ...
    parser.add_argument('--version', type=str, default='version1/tokenizer_96', help='version')
    ...
    parser.add_argument('--use_acc_vel_loss', type=bool, default=False, help='use acc vel loss') #rel_vel_loss
    
    parser.add_argument('--use_root_loss', type=bool, default=True, help='use root loss')
    parser.add_argument('--root_loss', type=float, default=0.03, help='root loss')
    parser.add_argument('--rel_vel_loss', type=float, default=0.03, help='root loss')
    parser.add_argument('--rel_vel_loss_unnorm', type=float, default=0.03, help='root loss')
    parser.add_argument('--root_rot_loss', type=float, default=0.01, help='root loss') #root_rot_vel_loss root_l1s_loss
    parser.add_argument('--root_l1s_loss', type=float, default=0.01, help='root loss')
    parser.add_argument('--root_rot_vel_loss', type=float, default=0.2, help='root loss') #root_rot_vel_lossparser.add_argument('--root_rot_vel_loss', type=float, default=0.2, help='root loss')

    parser.add_argument('--bn_loss', type=float, default=0.1, help='root loss')
    
    parser.add_argument('--acc_loss', type=float, default=0.5, help='acc loss')
    parser.add_argument('--acc_vel_loss', type=float, default=0.15, help='acc vel loss')
